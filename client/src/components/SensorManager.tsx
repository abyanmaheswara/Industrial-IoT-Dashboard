...
const SensorManager: React.FC = () => {
  ...
  return (
    <div className="p-6 rounded-xl border backdrop-blur-md bg-industrial-800/50 border-industrial-700 text-white">
      ...
      {loading ? (
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="border-b border-industrial-700 text-industrial-400">
            ...
            <tbody>
              {sensors.map(sensor => (
                <tr key={sensor.id} className="border-b border-industrial-700/50 hover:bg-industrial-700/30 transition-colors">
                  ...
                  <td className="p-3 text-right">
                    <div className="flex justify-end gap-2">
                      <button 
                        ...
                        className="p-2 rounded-lg transition-colors hover:bg-brand-500/10 text-brand-700"
                      >
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
          <div className="w-full max-w-md p-6 rounded-2xl shadow-2xl border bg-industrial-900 border-brand-500/30 text-white">
            <div className="flex justify-between items-center mb-6">
              <h3 className="text-lg font-bold">
                {editingSensor ? 'Edit Sensor' : 'Add New Sensor'}
              </h3>
              <button onClick={() => setIsModalOpen(false)} className="text-brand-700 hover:text-white transition-colors">
                <X className="w-5 h-5" />
              </button>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input 
                  ...
                  className={`w-full p-3 rounded-lg border outline-none transition-all bg-industrial-950 border-industrial-700 focus:border-brand-500 focus:ring-1 focus:ring-brand-500 ${editingSensor ? 'opacity-50 cursor-not-allowed' : ''}`}
              ...
              <div>
                ...
                <input 
                  ...
                  className="w-full p-3 rounded-lg border outline-none transition-all bg-industrial-950 border-industrial-700 focus:border-brand-500 focus:ring-1 focus:ring-brand-500"
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <select
                      ...
                      className="w-full p-3 rounded-lg border outline-none transition-all bg-industrial-950 border-industrial-700 focus:border-brand-500"
                    >
              ...
              <div className="flex justify-end gap-3 mt-6">
                <button 
                  ...
                  className="px-4 py-2 rounded-lg transition-colors text-brand-700 hover:text-white hover:bg-white/5"
                >
                  Cancel
                </button>
                <button 
